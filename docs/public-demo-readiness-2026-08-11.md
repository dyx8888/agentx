...
- Current local baseline anchor: `public-demo-local-20260811-v15`
- Verify tag target before push: `git rev-list -n 1 public-demo-local-20260811-v15`
...
- Previous tag `public-demo-local-20260811-v13` pointed to `3c69587`; then-current local baseline tag was `public-demo-local-20260811-v14`.
- GitHub Actions run `31455582367` completed successfully on code baseline `3c69587`.
  - `frontend-quick-gates`: success
  - `backend-quick-gates`: success
- Before this startup-degradation refresh, branch `origin/codex/public-demo-20260810` pointed to `7402aae`.
- Previous tag `public-demo-local-20260811-v14` pointed to `7402aae`; current local baseline tag is `public-demo-local-20260811-v15`.
- GitHub Actions run `31553983717` completed successfully on code baseline `7402aae`.
  - `frontend-quick-gates`: success
  - `backend-quick-gates`: success
...
- `tests/performance/public_demo_completion_audit.py` separates `local_ready`
  ...
  explicit pending external items.
...
- `tests/performance/public_demo_cloud_prereq_audit.py` checks local cloud deployment prerequisites without provider API calls.
  - Missing Vercel, Render, Neon, or production runtime credentials are recorded as `pending_external`; unsafe public CORS fails both the cloud prerequisite audit and the completion boundary audit.
