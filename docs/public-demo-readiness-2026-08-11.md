...
- Current local baseline anchor: `public-demo-local-20260811-v4`
- Verify tag target before push: `git rev-list -n 1 public-demo-local-20260811-v4`
...
1. Push `codex/public-demo-20260810` and `public-demo-local-20260811-v4` to
