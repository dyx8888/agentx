...
- Verify the tag points to the same commit with `git rev-list -n 1 --abbrev-commit public-demo-local-20260811-v8`
...
git rev-list -n 1 public-demo-local-20260811-v8
...
git push origin public-demo-local-20260811-v8
```
...
git push --dry-run origin codex/public-demo-20260810 public-demo-local-20260811-v8
```
...
- The remote tag `public-demo-local-20260811-v8` exists.
