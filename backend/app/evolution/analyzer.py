...
class EvolutionAnalyzer:
    ...
    def get_agent_modification_rate(self, agent_id: int, days: int = 7) -> ModificationRate:
        ...
        with self.get_connection() as conn:
            ...
            modification_rate = (
                (modified_count / total_feedback * 100) if total_feedback > 0 else 0.0
            )
    ...
    def get_tool_modification_rate(
        self, tool_name: str, company_id: int, days: int = 7
    ) -> ModificationRate:
        """
    ...
    def get_top_modified_agents(
        self, min_feedback: int = 5, days: int = 7
    ) -> list[AgentEvolutionData]:
        """
    ...
    def get_company_evolution_report(
        self, company_id: int, days: int = 7
    ) -> list[AgentEvolutionData]:
        """
